...
static const char *fonts[]          = { "Hack Nerd Font:size=12", "Font Awesome 6 Free:size=13" };
static const char dmenufont[]       = "monospace:size=13";
static const char col_gray1[]       = "#2B303B";
static const char col_gray2[]       = "#2B303B";
static const char col_gray3[]       = "#c5c8c6";
static const char col_gray4[]       = "#8E7F71";
static const char col_cyan[]        = "#2B303B";
...
static Key keys[] = {
	...
	{ ALTKEY,                       XK_Return, togglescratch,  {.v = scratchpadcmd } },
	{ MODKEY,                       XK_b,      togglebar,      {0} },
	{ MODKEY,			XK_w,	   spawn,	   SHCMD("firefox") },
	{ ALTKEY,			XK_p,	   spawn,	   SHCMD("st -e neomutt")},
	{ ALTKEY|ShiftMask,		XK_p,	   spawn,	   SHCMD("mbsync -a")},
	{ ALTKEY,			XK_m,	   spawn,	   SHCMD("st -e ncmpcpp")},
        { MODKEY,			XK_F9,	   spawn,	   SHCMD("dmenumount") },
	{ MODKEY,			XK_F10,	   spawn,	   SHCMD("dmenuumount") },
	{ ALTKEY,			XK_v,	   spawn,	   SHCMD("/home/kim/.scripts/vpn") },
	{ ALTKEY,			XK_x,	   spawn,	   SHCMD("/home/kim/.scripts/vpned") },
	...
	{ ALTKEY,                       XK_r,      setlayout,      {.v = &layouts[5]} },
